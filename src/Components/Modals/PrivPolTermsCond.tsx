                ...
                <Box sx={style}>
                    <CenterFrame>
                        <Container>
                            ...
                            <p>
                                MetaGaming Guild built the MetaSaga Warriors app as a Free
                                app. This SERVICE is provided by MetaGaming Guild at no
                            ...
                            <p>
                                ...
                                accessible at MetaSaga Warriors unless otherwise defined
                                in this Privacy Policy.
                            </p>
                            ...
                            <p>
                                ...
                                <a href="mailto:support@metasagawarriors.com">
                                    support@metasagawarriors.com
                                </a>
                                .
                            </p>
                        </Container>
                    ...
                    <CenterFrame>
                        <Container>
                            ...
                            <p>
                                ...
                                making it very clear to you exactly what you’re paying
                                for.
                            </p>
                            <p>
                                The MetaSaga Warriors app stores and processes personal
                                data that you have provided to us, in order to provide our
                                Service. It’s your responsibility to keep your phone and
                                access to the app secure. We therefore recommend that you
                                do not jailbreak or root your phone, which is the process
                                of removing software restrictions and limitations imposed
                                by the official operating system of your device. It could
                                make your phone vulnerable to malware/viruses/malicious
                                programs, compromise your phone’s security features and it
                                could mean that the MetaSaga Warriors app won’t work
                                properly or at all.
                            </p>
                            <p>
                                ...
                                or provided by your mobile network provider, but
                                MetaGaming Guild cannot take responsibility for the app
                            ...
                            <p>
                                ...
                                responsibility for the way you use the app i.e. You need
                                to make sure that your device stays charged – if it runs
                                out of battery and you can’t turn it on to avail the
                                Service, MetaGaming Guild cannot accept responsibility.
                            </p>
                            <p>
                                With respect to MetaGaming Guild’s responsibility for your
                                use of the app, when you’re using the app, it’s important
                                to bear in mind that although we endeavour to ensure that
                                it is updated and correct at all times, we do rely on
                                third parties to provide information to us so that we can
                                make it available to you. MetaGaming Guild accepts no
                                liability for any loss, direct or indirect, you experience
