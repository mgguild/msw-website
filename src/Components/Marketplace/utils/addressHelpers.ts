...
export const getAddress = (address: Address, chainId = MAINNET_CHAIN_ID): string | undefined => {
  return address[chainId as unknown as keyof Address] ?? address[MAINNET_CHAIN_ID]
}
