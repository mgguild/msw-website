    ...
    return (
        <div className="w-full h-auto bg-gradient-to-b from-[#2A2964] to-[#181020] py-[5em]">
            <div className="flex justify-center text-center items-center">
                <b className="text-[64px] bg-gradient-to-b from-[#4ED2FB] to-[#6B3CD3] bg-clip-text text-transparent font-black">
                    LOREM IPSUM
                </b>
            </div>
            <div className="flex justify-center text-center items-center font-black pb-[5em]">
                <a
                    href="/#/NFTMarket"
                    className="font-black text-[48px] text-[#ECAF02] underline"
                >
                    VIEW MORE
                </a>
            </div>
