...
const Filters = () => {
    ...
    return (
        <div className="flex flex-wrap justify-between items-center w-full">
            <b className="font-black text-[40px] text-transparent bg-clip-text bg-gradient-to-b from-[#4ED2FB] to-[#6B3CD3]">
                NFT MARKET
            </b>
            <Container>
                ...
                <TextWrapper className="filter-actions">Order By:</TextWrapper>
