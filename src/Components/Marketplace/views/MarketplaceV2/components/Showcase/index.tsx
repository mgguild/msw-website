          ...
          <div className="bg-[#131737] rounded-r-[20px] flex justify-center items-center flex-col">
            ...
            <p>Until x/x lorem ipsum</p>
                ...
                <div className="w-full flex justify-center mt-5">
                    <p className={`w-[75%] text-[${isScreen450 ? '25px' : '32px'}]`}>
                        Welcome to the official marketplace of MetaSaga Warriors! 🏹 Here,
                        you can dive into the dynamic world of Diggers, where buying and
                        selling prowess knows no bounds. Join the adventure as you
                        explore, trade, and conquer with your fellow warriors. Happy
                        trading!
                    </p>
                </div>
            </div>
