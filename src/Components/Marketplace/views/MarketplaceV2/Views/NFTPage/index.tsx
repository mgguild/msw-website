    ...
    const NftMain = (props: any) => {
        ...
        return loading ? (
            ...
            <ContentWrapper>
                ...
                <div>
                    <SpriteDisplay {...{ spriteURL: data ? data.img : '' }} />
                </div>
                ...
                {`${data?.listingData.seller}`.toUpperCase() !==
                `${address}`.toUpperCase() ? (
                    <Web3Button
                        contractAddress={'0x90ba9328748cf652f9bba12be0436acf4f782076'} // Your smart contract address
                        contractAbi={ABI}
                        action={async contract => {
                            await contract.call('buy', [params.lid], {
                                value: data?.listingData.price?.raw,
                            });
                        }}
                    ...
                    <Web3Button
                        ...
                        action={async contract => {
                            ...
                            if (!approvalData) {
                                ...
                                await contract.call('cancelListing', [params.lid]);
                            } else {
                                await contract.call('cancelListing', [params.lid]);
                            }
                            // listing id
