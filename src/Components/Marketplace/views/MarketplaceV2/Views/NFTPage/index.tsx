...
const NftMain = (props: any) => {
    ...
    return (
        <ContentWrapper>
            ...
            <div style={{ width: '70%' }}>
                <SpriteDisplay
                    {...{ spriteName: item.spriteName, width: 150, height: 150, style }}
                />
            </div>
            <Box className="secondary-drop-shadow">
                <TextWrapper align="center">
                    ...
                    <P fsize="0.7em" mt="1em">
                        This Latest data is being acquired. It will be available for
                        purchase as soon as the latest data is updated.
                    </P>
                </TextWrapper>
            </Box>
                        ...
                        <Flex flexDirection="column">
                            <TextWrapper align="left">
                                ...
                                <P fsize="0.6em">
                                    ...
                                    elit. Quos, voluptate quo, cumque nesciunt repellat ab
                                    animi nihil, nemo a quibusdam sint.
                                </P>
                            </TextWrapper>
                        </Flex>
                    </MiniBox>
