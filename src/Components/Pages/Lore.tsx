    ...
    return (
        <Carousel showThumbs={false}>
            <div style={{ position: 'relative' }}>
                <img src={require(`../../Assets/img/${isScreen800 ? isScreen650 ? 'mobile_lore_sm.png' : 'mobile_lore.png' : 'lore.jpg'}`)} />
            ...
            <div>
                <img src={require(`../../Assets/img/${isScreen800 ? isScreen650 ? 'mobile_lore2_sm.png' : 'mobile_lore2.png' : 'lore_2.png'}`)} />
                <Scroll isScreen800={isScreen800}>
                    <p className='second'>
    ...
    return (
        <>
            <div className="page-section" id="lore" style={{padding: '0'}}>
                ...
                <SectCont margin="0">
                    <CarouselCont>
                        <DemoCarousel isScreen800={isScreen800} isScreen650={isScreen650} />
                    </CarouselCont>
                </SectCont>
            </div>
        </>
